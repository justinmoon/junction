...
from ckcc.cli import show_address, AF_P2WSH, AF_P2WSH_P2SH, a2b_hex, str_to_int_path
...
def display_multisig_address(redeem_script_hex, derivation_paths, segwit):
    ...
    dev.send_recv(CCProtocolPacker.show_p2sh_address(
